...
# Configured with: './configure' '--target-list=x86_64-softmmu' '--enable-spice'
all:
prefix=/usr/local
bindir=${prefix}/bin
libdir=${prefix}/lib
...
libs_softmmu=-lnss3 -lnssutil3 -lsmime3 -lssl3 -lplds4 -lplc4 -lnspr4   -pthread -lgthread-2.0 -lrt -lglib-2.0   -lutil -lncurses -ltinfo    -lpng12   -ljpeg -lsasl2 -lSDL   -lX11  -lz  -L/usr/local/lib -lspice-server   -L/usr/local/lib -lpixman-1  
ARCH=x86_64
STRIP=strip
CONFIG_POSIX=y
CONFIG_LINUX=y
...
VERSION=1.6.50
PKGVERSION=
SRC_PATH=/home/mbarboi/pcc/src/qemu
...
libcacard_libs=-lnss3 -lnssutil3 -lsmime3 -lssl3 -lplds4 -lplc4 -lnspr4   -pthread -lgthread-2.0 -lrt -lglib-2.0  
libcacard_cflags=-I/usr/include/nss -I/usr/include/nspr   -pthread -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include  
CONFIG_GLX=y
GLX_LIBS=-lGL -lX11
...
QEMU_CFLAGS=-fPIE -DPIE -m64 -D_GNU_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Wstrict-prototypes -Wredundant-decls -Wall -Wundef -Wwrite-strings -Wmissing-prototypes -fno-strict-aliasing  -Wendif-labels -Wmissing-include-dirs -Wempty-body -Wnested-externs -Wformat-security -Wformat-y2k -Winit-self -Wignored-qualifiers -Wold-style-declaration -Wold-style-definition -Wtype-limits -fstack-protector-all   -I/usr/include/libpng12   -I/usr/local/include/spice-server -I/usr/local/include/pixman-1 -I/usr/local/include -I/usr/local/include/spice-1 -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include   -I/usr/include/nss -I/usr/include/nspr   -pthread -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include   -I/usr/local/include/pixman-1   
QEMU_INCLUDES=-I$(SRC_PATH)/tcg -I$(SRC_PATH)/tcg/i386 -I$(SRC_PATH)/linux-headers -I/home/mbarboi/pcc/src/qemu/linux-headers -I. -I$(SRC_PATH) -I$(SRC_PATH)/include -I$(SRC_PATH)/libcacard
AUTOCONF_HOST := 
